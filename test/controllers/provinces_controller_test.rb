...
class ProvincesControllerTest < ActionController::TestCase
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post :create, province: { id: @province.id, level: @province.level, name: @province.name, source: @province.source }
    end
  ...
  test "should update province" do
    patch :update, id: @province, province: { id: @province.id, level: @province.level, name: @province.name, source: @province.source }
    assert_redirected_to province_path(assigns(:province))
  end
