class HoldingsController < ApplicationController
  ...
  private
    ...
    def holding_params
      params.require(:holding).permit(:holding_id, :leve, :bastionLevel, :provinceProtects, :visibility, :contested, :name, :type, :originalName, :ruledUpThisTurn, :rpExpenditureThisTurn, :gpExpenditureTHisTUrn)
    end
end
